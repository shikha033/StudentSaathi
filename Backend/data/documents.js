...
const documentData = [
    ...
    },
    {
        ...
        steps: "Visit the NSDL or UTIITSL portal and select 'New PAN' → Choose Form 49A (Indian citizens) → Fill in personal, contact and Aadhaar details → Upload scanned photo, signature and supporting documents → Pay the application fee online → e-Sign/e-KYC using Aadhaar OTP (for instant e-PAN) → Note your Acknowledgement Number and track status online → Receive e-PAN by email and physical card by post.",
        required_documents: [
            "Proof of Identity: Aadhaar Card, Voter ID, Passport, or Driving License",
            "Proof of Address: Aadhaar Card, Utility Bill, Bank Statement, or Passport",
            "Proof of Date of Birth: Birth Certificate, Matriculation Certificate, or Aadhaar Card",
            "Passport-size Photograph (for physical/paperless application)"
        ],
        eligibility: "Indian citizens and NRIs.",
        application_fee: "₹107 (with Aadhaar e-KYC) to ₹1,017 (foreign address dispatch).",
        processing_time: "e-PAN in 30 minutes to 2 hours (Instant e-PAN via Aadhaar), physical card 10-15 days.",
        official_links: [
            { name: 'Apply NSDL', url: 'https://tin.tin.nsdl.com/pan/applyPan.html' },
    ...
    },
    {
        ...
        steps: "Visit the National Voters Service Portal (NVSP) or Voter Helpline App → Select Form 6 (new voter) → Fill personal, address and constituency details → Upload passport photo, age and address proof → Submit the form online → Booth Level Officer (BLO) conducts a field verification visit → Application approved by Electoral Registration Officer → Download e-EPIC or collect the physical card.",
        required_documents: [
            "Proof of Age: Birth Certificate, Aadhaar Card, 10th Marksheet, or Passport",
            "Proof of Address: Aadhaar Card, Ration Card, Utility Bill, or Rent Agreement",
            "Recent Passport-size Photograph"
        ],
        eligibility: "Indian citizens aged 18+ as on the qualifying date, ordinarily resident in the constituency.",
        application_fee: "Free.",
        processing_time: "30-45 days after field verification.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Apply for a Learner's License (LL) on the Sarathi Parivahan portal → Pass the online LL test on road signs/rules → Receive Learner's License (valid 6 months) → Practice driving and wait at least 30 days → Book a slot for the Permanent Driving License (DL) test at the RTO → Appear for the driving skill test with your vehicle → On passing, pay the fee and receive your Permanent DL by post.",
        required_documents: [
            "Age & Identity Proof: Aadhaar Card, Passport, or Birth Certificate",
            "Address Proof: Aadhaar Card, Utility Bill, or Passport",
            "Passport-size Photographs and Signature scan",
            "Medical Certificate (Form 1A) — required for transport vehicles or applicants above 40"
        ],
        eligibility: "18+ for two-wheelers/cars (with gear), 16+ for gearless two-wheelers up to 50cc, 20+ for transport vehicles.",
        application_fee: "Learner's License ~₹150-₹200; Permanent DL ~₹200-₹500 (varies by state).",
        processing_time: "LL issued same day; Permanent DL 7-15 days after the driving test.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Visit your State's Food & Civil Supplies / e-District portal → Select 'New Ration Card' application → Fill family details with the Head of Family's information → Upload identity, address and income proofs → Pay the nominal application fee → Field visit/verification by the local Food Inspector → Card approved and either e-Ration Card issued digitally or physical card delivered.",
        required_documents: [
            "Identity Proof of Head of Family: Aadhaar Card, Voter ID, or Passport",
            "Address Proof: Aadhaar Card, Rent Agreement, or Electricity Bill",
            "Family Details: Passport photos of all family members, Aadhaar of each member",
            "Income Proof (for BPL/priority category cards) and Surrender Certificate if migrating from another state"
        ],
        eligibility: "Varies by state and income category (AAY/BPL/APL); generally any resident household without an existing card.",
        application_fee: "Usually free or nominal (₹5-₹45).",
        processing_time: "15-30 days after field verification.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Report the birth to the local municipal corporation/Panchayat within 21 days (hospitals usually do this automatically) → If registered within 21 days, apply for the certificate directly on the CRS portal → If delayed (after 21 days/1 year), submit an affidavit and get approval from the Registrar/authorized officer → Pay the applicable fee → Certificate is issued digitally or as a physical copy.",
        required_documents: [
            "Hospital/Institutional Birth Record or Discharge Summary",
            "Parents' Identity Proof: Aadhaar Card, Voter ID",
            "Parents' Address Proof",
            "Affidavit and supporting documents (only required for late registration beyond 1 year)"
        ],
        eligibility: "Applicable for all births occurring in India; registration is legally mandatory.",
        application_fee: "Free if registered within 21 days; nominal late fee thereafter.",
        processing_time: "7-30 days (registered within 21 days); longer for delayed registration requiring approval.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Visit the ABHA (NDHM) website or app → Choose to register using Aadhaar or Driving License/mobile number → Enter your Aadhaar number and verify with OTP sent to your linked mobile → Fill in basic profile details (name, DOB, gender, address) → Choose your unique ABHA address (e.g., yourname@abdm) → Your 14-digit ABHA number is generated instantly → Download your ABHA Card as PDF.",
        required_documents: [
            "Aadhaar Card (linked to an active mobile number) OR Driving License",
    ...
    },
    {
        ...
        steps: "Register on the Swavlamban (UDID) portal → Fill the online application with personal and disability details → Upload photograph, signature and any existing disability certificate → Submit and book an appointment for medical assessment (if no prior certificate exists) → Appear before the District Medical Board for evaluation → Board issues the Disability Certificate and UDID number → Download/collect your UDID Card.",
        required_documents: [
            "Existing Disability Certificate (if previously issued) — otherwise medical assessment is done during the process",
            "Identity Proof: Aadhaar Card",
            "Address Proof",
            "Recent Passport-size Photograph and Signature"
        ],
        eligibility: "Persons with a benchmark disability (40% or more) as defined under the RPwD Act, 2016.",
        application_fee: "Free.",
        processing_time: "15-30 days after Medical Board assessment.",
        official_links: [
            { name: 'UDID Portal', url: 'https://www.swavlambancard.gov.in/' },
        ],
    },
    ...
    // =======================================================
    {
        ...
        steps: "Write a formal application addressed to the Principal/Head of Institution (or use the institute's online student portal, if available) → Clearly state the purpose (e.g., passport, scholarship, bank account, visa) → Attach your Student ID/latest fee receipt as proof of enrolment → Submit to the college/school administrative office → Collect the signed and stamped certificate from the office on the specified date.",
        required_documents: [
            "Student ID Card or latest Fee Receipt",
            "Written Application specifying the exact purpose",
            "Passport-size Photograph (if required by the institute)"
        ],
        eligibility: "Current, enrolled student of the institution.",
        application_fee: "Usually nominal or free; varies by institute.",
        processing_time: "1-7 days, varies by institute.",
        official_links: [],
    },
    {
        ...
        steps: "Visit your State's e-District/Revenue portal or the local Tehsildar/SDM office → Fill the income certificate application form with family income details → Upload supporting income proof, identity and address documents → Pay the nominal fee → Application is verified by the Revenue Inspector/Patwari (may include a local enquiry) → Tehsildar/SDM digitally signs and issues the certificate → Download or collect the certificate.",
        required_documents: [
            "Identity Proof: Aadhaar Card",
            "Address Proof: Ration Card or Utility Bill",
            "Income Proof: Salary Slips, Form 16, or Self-Employment/Agricultural Income Declaration",
            "Passport-size Photograph"
        ],
        eligibility: "Varies based on state/scheme criteria; typically any resident needing to prove family income.",
        application_fee: "Nominal or free.",
        processing_time: "7-15 days, varies by state.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Apply via your State's e-District/Revenue portal or local Tehsildar office → Fill the application specifying your caste/sub-caste and category (SC/ST/OBC) → Upload identity, residence proof and any existing family caste record (e.g., father's/grandfather's caste certificate) → Application is verified by the Revenue/Village officer, sometimes with a local enquiry → Tehsildar/SDM approves and issues the digitally signed certificate → Download or collect the certificate.",
        required_documents: [
            "Identity Proof: Aadhaar Card",
            "Residential Proof: Ration Card or Utility Bill",
            "Existing Community/Caste Certificate of a blood relative (father/grandfather), where available",
            "Passport-size Photograph"
        ],
        eligibility: "Belonging to a caste/tribe recognized as SC, ST, or OBC in the relevant state/central list.",
        application_fee: "Nominal or free.",
        processing_time: "15-30 days, varies by state.",
        official_links: [
    ...
    },
    {
        ...
        steps: "Apply via your State's e-District/Revenue portal or local Tehsildar office → Fill in the application, declaring the number of years of continuous residence in the state → Upload address proofs covering the required residency period (e.g., 10-15 years, varies by state) and identity documents → Application verified by the Revenue/Village officer → Tehsildar/SDM approves and digitally signs the certificate → Download or collect the certificate.",
        required_documents: [
            "Identity Proof: Aadhaar Card",
            "Long-term Address Proof: School leaving certificates, old Ration Cards, or property documents covering the residency period",
            "Passport-size Photograph"
        ],
        eligibility: "Continuous residence in the state for the period defined by that state's rules (commonly 10-15 years).",
    ...
    },
    {
        ...
        steps: "Submit a written application to the school/college administrative office requesting the TC → Clear all outstanding fee dues, library books and other institutional clearances → Institution verifies your attendance and academic records → Head of Institution signs and stamps the certificate → Collect the original TC on the specified date (usually needed for admission to a new institution).",
        required_documents: [
            "Written Application for TC",
            "Fee Clearance Certificate / No-Dues Slip from all departments (library, hostel, etc.)",
            "Student ID Card"
        ],
        eligibility: "Former or currently enrolled student of the institution seeking to transfer out.",
        application_fee: "Usually no fee or nominal.",
        processing_time: "3-10 days, varies by institute.",
        official_links: [],
    },
