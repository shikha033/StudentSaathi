export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[var(--brand-navy)] via-[var(--brand-navy-light)] to-[var(--brand-blue)] text-white py-12 mt-16 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        <div className="mb-6">
          <h3 className="text-white mb-2">StudentSaathi</h3>
        ...
        <div className="border-t border-white/20 pt-6">
          <p className="text-blue-200">StudentSaathi © 2025 | All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
