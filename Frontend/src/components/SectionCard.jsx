import { CreditCard, FileText, Award, GraduationCap, Briefcase } from 'lucide-react';

const categoryColors = {
  document: 'from-[var(--brand-blue)] to-[var(--brand-navy)]',
  ...
  default: 'from-[var(--brand-blue)] to-[var(--brand-navy)]'
};
...
export default function SectionCard({ title, onClick, category = 'default' }) {
